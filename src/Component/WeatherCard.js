...
export default function WeatherCard({ data }) {
  ...
  return (
    <div className="dark:bg-[#70BDC2] bg-gray-700 dark:text-black rounded-xl p-6 w-full max-w-md shadow-lg">
      <h2 className="text-2xl font-bold text-center mb-2 dark:text-gray-900 text-gray-300 ">
        {data.name}
      </h2>
      ...
      {/* Weather Description */}
      <p className="text-center capitalize mb-6 dark:text-gray-900 text-gray-300">
        {description}
      </p>
